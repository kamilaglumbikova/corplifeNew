                                ...
                                <View style={styles.modalContainer}>
                                    ...
                                    <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.formContainer}>
                                        <View style={styles.inputContainer}>
                                            <TextInput
                                                style={[styles.input, ((validCode !== 'VALID' && code.length === 19) || !confirmCode) && { borderColor: COLORS.error }]}
                                                value={code}
                                            ...
                                            {((validCode !== 'VALID' && code.length === 19) || !confirmCode) && <Text style={styles.errorText}>Gültigen Code eingeben</Text>}
                                        </View>
